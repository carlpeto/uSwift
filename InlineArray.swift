...
extension InlineArray where Element: ~Copyable {
  ...
  internal var _address: UnsafePointer<Element> {
    ...
    unsafe UnsafePointer<Element>(knownNotNilRawPointer: Builtin.unprotectedAddressOfBorrow(_storage))
#else
    unsafe UnsafePointer<Element>(knownNotNilRawPointer: Builtin.unprotectedAddressOfBorrow(self))
#endif
  }
...
#if $AddressOfProperty
    unsafe UnsafePointer<Element>(knownNotNilRawPointer: Builtin.addressOfBorrow(_storage))
#else
    unsafe UnsafePointer<Element>(knownNotNilRawPointer: Builtin.addressOfBorrow(self))
#endif
  }
  ...
  internal var _mutableAddress: UnsafeMutablePointer<Element> {
    mutating get {
#if $AddressOfProperty
      unsafe UnsafeMutablePointer<Element>(knownNotNilRawPointer: Builtin.unprotectedAddressOf(&_storage))
#else
      unsafe UnsafeMutablePointer<Element>(knownNotNilRawPointer: Builtin.unprotectedAddressOf(&self))
#endif
    }
  }
  ...
  internal var _protectedMutableAddress: UnsafeMutablePointer<Element> {
    mutating get {
#if $AddressOfProperty
      unsafe UnsafeMutablePointer<Element>(knownNotNilRawPointer: Builtin.addressof(&_storage))
#else
      unsafe UnsafeMutablePointer<Element>(knownNotNilRawPointer: Builtin.addressof(&self))
#endif
    }
  }
