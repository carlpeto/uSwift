...
extension Int {
  ...
  public struct Words : RandomAccessCollection {
    ...
    public subscript(position: Int) -> UInt {
      get {
        ...
        let shift = UInt(position._value) &* 32
  ...
  public var byteSwapped: Int {
    return Int(Builtin.int_bswap_Int32(_value))
  }
  ...
  public func multipliedFullWidth(by other: Int)
    ...
    let low = Int.Magnitude(Builtin.truncOrBitCast_Int64_Int32(res))
    let shift = Builtin.zextOrBitCast_Int8_Int64(UInt8(32)._value)
    let shifted = Builtin.ashr_Int64(res, shift)
    let high = Int(Builtin.truncOrBitCast_Int64_Int32(shifted))
...
extension UInt {
  ...
  public var byteSwapped: UInt {
    return UInt(Builtin.int_bswap_Int32(_value))
  }
  ...
  public func multipliedFullWidth(by other: UInt)
    ...
    let res = Builtin.mul_Int64(lhs_, rhs_)
    let low = UInt.Magnitude(Builtin.truncOrBitCast_Int64_Int32(res))
    let shift = Builtin.zextOrBitCast_Int8_Int64(UInt8(32)._value)
    let shifted = Builtin.ashr_Int64(res, shift)
    let high = UInt(Builtin.truncOrBitCast_Int64_Int32(shifted))
    return (high: high, low: low)
  }
...
extension Int64 {
  ...
  public init(_truncatingBits bits: UInt) {
    ...
    self.init(Builtin.zextOrBitCast_Int32_Int64(bits._value))
  }
  ...
  var _lowWord: UInt {
    return UInt(
      Builtin.truncOrBitCast_Int64_Int32(_value)
    )
  }
}
...
extension Int16 {
  ...
  init(_truncatingBits bits: UInt) {
    self.init(Builtin.truncOrBitCast_Int32_Int16(bits._value))
  }

  @_transparent
  public // transparent
  var _lowWord: UInt {
    return UInt(Builtin.sextOrBitCast_Int16_Int32(_value))
  }
}
...
extension Int8 {
  @_transparent
  public init(_truncatingBits bits: UInt) {
    self.init(Builtin.truncOrBitCast_Int32_Int8(bits._value))
  }
  ...
  var _lowWord: UInt {
    return UInt(
      Builtin.sextOrBitCast_Int8_Int32(_value)
    )
  }
}
...
extension UInt8 {
  ...
  var _lowWord: UInt {
    return UInt(
      Builtin.zextOrBitCast_Int8_Int32(_value)
    )
  }
}
  ...
  public init<Source : BinaryInteger>(_ value: Source) {
    if value.bitWidth <= 32 {
      if Source.isSigned {
        ...
        _value = Builtin.sitofp_Int32_FPIEEE32(asInt._value)
      } else {
        let asUInt = Int(truncatingIfNeeded: value)
        _value = Builtin.uitofp_Int32_FPIEEE32(asUInt._value)
      }
    } else {
...
extension Float16 {
  ...
  public init<Source: BinaryInteger>(_ value: Source) {
    if value.bitWidth <= 32 {
      if Source.isSigned {
        let asInt = Int(truncatingIfNeeded: value)
        _value = Builtin.sitofp_Int32_FPIEEE16(asInt._value)
      } else {
        let asUInt = UInt(truncatingIfNeeded: value)
        _value = Builtin.uitofp_Int32_FPIEEE16(asUInt._value)
      }
    } else {
