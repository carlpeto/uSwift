...
>(
  ...
  try unsafe body(UnsafeMutablePointer<T>(knownNotNilRawPointer: Builtin.addressof(&value)))
}
...
internal func __abi_se0413_withUnsafeMutablePointer<T, Result>(
  ...
  return try unsafe body(UnsafeMutablePointer<T>(knownNotNilRawPointer: Builtin.addressof(&value)))
}
...
) throws(E) -> Result
{
  ...
  return try unsafe body(UnsafeMutablePointer<T>(knownNotNilRawPointer: Builtin.unprotectedAddressOf(&value)))
#else
  return try body(UnsafeMutablePointer<T>(knownNotNilRawPointer: Builtin.addressof(&value)))
#endif
}
...
{
  return try unsafe body(UnsafePointer<T>(knownNotNilRawPointer: Builtin.addressOfBorrow(value)))
}
...
public func withUnsafePointer<T: ~Copyable, E: Error, Result: ~Copyable>(
  ...
  try unsafe body(UnsafePointer<T>(knownNotNilRawPointer: Builtin.addressof(&value)))
}
...
internal func __abi_se0413_withUnsafePointer<T, Result>(
  ...
  return try unsafe body(UnsafePointer<T>(knownNotNilRawPointer: Builtin.addressof(&value)))
}
...
#if $BuiltinUnprotectedAddressOf
  return try unsafe body(UnsafePointer<T>(knownNotNilRawPointer: Builtin.unprotectedAddressOf(&value)))
#else
  return try body(UnsafePointer<T>(knownNotNilRawPointer: Builtin.addressof(&value)))
#endif
}
...
>(
  ...
  return try unsafe body(UnsafePointer<T>(knownNotNilRawPointer: Builtin.unprotectedAddressOfBorrow(value)))
}
