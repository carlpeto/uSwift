...
extension Unicode.UTF8 : _UnicodeEncoding {
  ...
  public static func transcode<FromEncoding : _UnicodeEncoding>(
    ...
    if _fastPath(FromEncoding.self == UTF16.self) {
      ...
      r &<<= 8
      if _fastPath(u0 & (UInt16(0xF800) &>> 6) != (UInt16(0xD800) &>> 6)) {
        u0 &>>= 6
        return EncodedScalar(
...
extension UTF8.ReverseParser : Unicode.Parser, _UTFParser {
  ...
  public func _parseMultipleCodeUnits() -> (isValid: Bool, bitCount: UInt8) {
    ...
    if _buffer._storage                & 0b0__1110_0000__1100_0000
      ...
      if _fastPath(
        top5Bits != 0 &&    top5Bits != UInt32(0b0__1101__0010_0000__0000_0000)) {
        return (true, 3*8)
      }
    }
  ...
  internal func _invalidLength() -> UInt8 {
    if _buffer._storage                 & 0b0__1111_0000__1100_0000
      ...
      let top5Bits: UInt32 = _buffer._storage        & 0b0__1111__0010_0000
      if top5Bits != 0 &&          top5Bits != UInt32(0b0__1101__0010_0000) { return 2 }
    }
...
extension Unicode.UTF8.ForwardParser : Unicode.Parser, _UTFParser {
  ...
  public func _parseMultipleCodeUnits() -> (isValid: Bool, bitCount: UInt8) {
    ...
    if _buffer._storage & 0b0__1100_0000__1110_0000
    ...
    else if _buffer._storage         & 0b0__1100_0000__1100_0000__1111_0000 as UInt32
                                    == 0b0__1000_0000__1000_0000__1110_0000 as UInt32 {
      // 3-byte sequence. The top 5 bits of the decoded result must be nonzero
      // and not a surrogate
      let top5Bits: UInt32 =          _buffer._storage & 0b0___0010_0000__0000_1111
      if _fastPath(top5Bits != 0 && top5Bits != UInt32(0b0___0010_0000__0000_1101)) {
        return (true, 3*8)
      }
    }
    else if _buffer._storage & 0b0__1100_0000__1100_0000__1100_0000__1111_1000 as UInt32
                            == 0b0__1000_0000__1000_0000__1000_0000__1111_0000 as UInt32 {
      ...
      if _fastPath(
        top5bits != 0
        && top5bits.byteSwapped                   <= 0b0__0000_0100__0000_0000 as UInt16
      ) { return (true, 4*8) }
    }
    return (false, _invalidLength() &* 8)
  }
  ...
  internal func _invalidLength() -> UInt8 {
    if _buffer._storage               & 0b0__1100_0000__1111_0000
                                     == 0b0__1000_0000__1110_0000 as UInt16 {
      // 2-byte prefix of 3-byte sequence. The top 5 bits of the decoded result
      // must be nonzero and not a surrogate
      let top5Bits = _buffer._storage & 0b0__0010_0000__0000_1111
      if top5Bits != 0 && top5Bits   != 0b0__0010_0000__0000_1101 as UInt16 { return 2 }
    }
    else if _buffer._storage                & 0b0__1100_0000__1111_1000
                                           == 0b0__1000_0000__1111_0000 as UInt16
    {
      // Prefix of 4-byte sequence. The top 5 bits of the decoded result
      // must be nonzero and no greater than 0b0__0100_0000
      let top5bits = UInt16(_buffer._storage & 0b0__0011_0000__0000_0111)
      if top5bits != 0 && top5bits.byteSwapped <= 0b0__0000_0100__0000_0000 as UInt16 {
        return _buffer._storage   & 0b0__1100_0000__0000_0000__0000_0000 as UInt32
                                 == 0b0__1000_0000__0000_0000__0000_0000 as UInt32 ? 3 : 2
      }
    }
    return 1
  }
